...
\begin{abstract}
    ...
    themselves, effectively delegating to theem the job of rescheduling when
    updates from their dependencies are detected.

    The architecture is validated through a fully functional prototype,
