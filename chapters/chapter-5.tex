...
\begin{itemize}
	...
	\item As explained in \Cref{ssec:eager_lazy}, a reactive \ac{DES} must be
	      eager when scheduling and rescheduling reactions. On the rest of the
	      system (e.g. complex reactions propensities re-evaluation), the
	      system could exploit laziness to reduce the CPU usage for future
	      reactions that will be re-evaluated when needed.
\end{itemize}
